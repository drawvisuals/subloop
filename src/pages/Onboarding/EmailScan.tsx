		...
		<div className="min-h-screen bg-neutral-50 flex items-center justify-center px-4 sm:px-6 md:px-10 py-12 sm:py-16 md:py-20">
			...
			<div className="w-full max-w-[439px] flex flex-col gap-6 sm:gap-8 items-center">
				...
				<div className="w-full flex flex-col gap-3 items-center">
					...
					{/* Description */}
					<p className="font-normal min-h-[63px] leading-5 sm:leading-[22px] text-sm sm:text-base text-neutral-700 text-center tracking-tight whitespace-pre-wrap w-full">
				...
				<div className="w-full bg-neutral-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 flex flex-col gap-4 sm:gap-5 items-center">
					<EmailProviderRow
						provider="gmail"
