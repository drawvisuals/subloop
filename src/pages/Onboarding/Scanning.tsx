...
export default function Scanning() {
    ...
    const interval = setInterval(() => {
      setProgress((prev) => {
        if (prev >= 100) {
          ...
          // Auto-redirect on completion (stubbed)
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-10 py-20">
      ...
      <div className="w-full max-w-[438px] flex flex-col gap-8 items-center justify-center">
        {/* Icon + Title */}
        ...
        <div className="w-full bg-neutral-50 rounded-2xl p-1 flex flex-col gap-2 items-center">
          {/* Scanning Status Row */}
