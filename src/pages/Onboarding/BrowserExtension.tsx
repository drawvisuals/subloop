...
export default function BrowserExtension() {
	...
	return (
		<div className="min-h-screen bg-neutral-100 flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 py-8 sm:py-12">
			{/* Logo */}
				...
				<div className="w-full max-w-[439px] flex flex-col gap-6 sm:gap-8 items-center">
					...
					<div className="w-full flex flex-col gap-3 items-center">
						<div className="w-full flex flex-col gap-3 items-center">
							...
							{/* Title */}
							<h1 className="font-semibold leading-8 sm:leading-9 text-2xl sm:text-[30px] text-center text-white tracking-tight whitespace-pre-wrap w-full px-2">
								Track new subscriptions{'\n'}with browser reading
							</h1>
						</div>

						{/* Description */}
						<p className="font-normal leading-5 sm:leading-[22px] text-sm sm:text-base text-neutral-700 text-center tracking-tight whitespace-pre-wrap w-full px-2">
					...
					<div className="w-full flex flex-col gap-3 items-start">
						...
						<button
							type="button"
							onClick={handleSkip}
							className="w-full min-h-[44px] sm:min-h-[22px] sm:h-[22px] py-2 sm:py-0 font-normal leading-5 sm:leading-[22px] text-sm sm:text-base text-neutral-700 text-center tracking-tight hover:text-brand-primary-500 transition-colors active:opacity-75"
						>
							Skip for now
						</button>
					</div>
			...
			<div className="flex flex-col sm:flex-row gap-2 items-center justify-center mt-6 sm:mt-8 px-4">
				...
				<p className="font-normal leading-5 sm:leading-[22px] text-xs sm:text-base text-neutral-700 text-center tracking-tight">
