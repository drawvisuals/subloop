...
export default function Pricing() {
  ...
  const renderFeatureValue = (value: string | boolean) => {
    ...
    if (value === false) {
      return <X className="w-5 h-5 text-neutral-700 shrink-0" />;
    }
      ...
      <div className="pt-16 pb-20">
        ...
        <div className="max-w-5xl mx-auto flex justify-center mb-8">
          <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-1 flex gap-1">
            <button
              ...
              className={`px-4 py-2 rounded-md font-medium text-sm leading-5 transition-colors ${
                billingCycle === 'monthly'
                  ? 'bg-brand-primary-500 text-neutral-900'
            ...
            >
              Yearly
              <span className="ml-1 text-xs text-neutral-900/80">(Save 17%)</span>
            </button>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-brand-primary-500 border-2 border-brand-primary-500 rounded-lg p-8 flex flex-col gap-6 relative">
            ...
            <div className="flex flex-col gap-2">
              <h2 className="font-semibold text-2xl leading-8 text-neutral-900">
                Pro
              </h2>
              <div className="flex flex-col gap-1">
                ...
                {billingCycle === 'yearly' && (
                  <span className="font-normal text-sm leading-5 text-neutral-900/70">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <h2 className="font-semibold text-2xl leading-8 text-white text-center mb-8">
            Feature comparison
          </h2>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-neutral-700">
                    <th className="px-6 py-4 text-left font-semibold text-base leading-[22px] text-white">
                      Feature
                    </th>
                    <th className="px-6 py-4 text-center font-semibold text-base leading-[22px] text-white">
                      Free
                    </th>
                    <th className="px-6 py-4 text-center font-semibold text-base leading-[22px] text-white">
                      Pro
                ...
                <tbody>
                  {features.map((feature, index) => (
                    ...
                    >
                      <td className="px-6 py-4 font-normal text-base leading-[22px] text-white">
                        {feature.name}
                      </td>
